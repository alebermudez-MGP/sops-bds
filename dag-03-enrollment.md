...
- [ ] Verify merchant name matches the contract (or driver's license, if provided)
...
- [ ] After CS email is received, add the info to the DAG Enrollments 2026 Google Sheet (Expected Earn Fee = Estimated Total Fee Amount at Time of UW)
...
<br><br>
📖 See <a href="./dag-05-quick-reference#section-8--document-verification">05 — Quick Reference, Section 8</a> for the full document verification checklist (Creditor Contracts, Bank Statements).
</details>
...
> ⚠️ **Expected Earn Fee** — effective immediately, this value must be taken from the **Estimated TOTAL Fee Amount At Time Of UW** field in Salesforce (Underwriting section). Use this value consistently to maintain accuracy across records and reporting.
...
- Whenever a document is received (contract, bank statement, license), verify it and extract the relevant details, updating the merchant's name in Salesforce to match the contract if needed — see [05 — Quick Reference, Section 8](./dag-05-quick-reference#section-8--document-verification).
- The Expected Earn Fee entered on the DAG Enrollments 2026 Google Sheet must always come from the **Estimated Total Fee Amount at Time of UW** field.
...
- [ ] CS email received → row added to DAG Enrollments 2026 sheet (Expected Earn Fee = Estimated Total Fee Amount at Time of UW)
